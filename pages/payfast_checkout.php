...
<section class="st-hero-band">
    <span class="st-kicker"><?= sisonke_e(sisonke_t('payfast_kicker')) ?></span>
    <h1 class="st-title"><?= sisonke_e(sisonke_t('payfast_heading')) ?></h1>
    <p class="st-lede"><?= sisonke_e(sisonke_t('payfast_lede')) ?></p>
</section>
...
<section class="st-page">
    ...
    <div class="st-grid st-grid-2">
        <article class="st-card">
            <div class="st-card-body">
                ...
                <dl class="row mb-0">
                    ...
                    <dd class="col-sm-7"><?= sisonke_e(sisonke_t('payfast_sandbox')) ?></dd>
                </dl>
            </div>
        </article>
        ...
        <article class="st-card">
            <div class="st-card-body">
                <h2 class="st-card-title mb-3"><?= sisonke_e(sisonke_t('sandbox_actions')) ?></h2>
                <p><?= sisonke_e(sisonke_t('sandbox_actions_text')) ?></p>
                ...
                <form method="post" action="<?= sisonke_e(sisonke_payfast_endpoint()) ?>" class="mb-3">
                    ...
                    <?php endforeach; ?>
                    <button class="st-btn st-btn-yellow" type="submit"><?= sisonke_e(sisonke_t('open_payfast')) ?></button>
                </form>
