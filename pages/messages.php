...
$conversations = sisonke_fetch_user_conversations($pdo, $userId, (string) $_SESSION['user_role']);
...
<section class="st-hero-band">
    ...
    <h1 class="st-title"><?= sisonke_e(sisonke_t('messages_inbox_heading')) ?></h1>
    <p class="st-lede"><?= sisonke_e(sisonke_t('messages_inbox_lede_buyer')) ?></p>
</section>

<section class="st-page">
    <?php if ($conversations === []): ?>
        <div class="st-empty">
            <?= sisonke_e(sisonke_t('messages_inbox_empty_buyer')) ?>
            ...
            <?php foreach ($conversations as $thread): ?>
                <a class="st-message-inbox-item" href="<?= sisonke_e(sisonke_conversation_thread_url((int) $thread['conversation_id'])) ?>">
                    <div class="st-message-inbox-main">
                        ...
                        <span class="st-meta"><?= sisonke_e(sisonke_t('messages_with_seller', ['name' => (string) $thread['other_party']])) ?></span>
